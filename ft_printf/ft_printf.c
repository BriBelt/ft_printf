...
/*   Updated: 2023/04/14 20:29:20 by bbeltran         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
//	char	*str = NULL;	
//	printf("%u, Hello %d, %c %s %%, hex %x %X", 123, -42, 'a', str, 9, 31);
//	int	i = printf("\001\002\007\v\010\f\r\n");
//	printf("\nOriginal unsigned long ptr val: %lu\n", -1);
//	printf("\nOriginal ptr val: %p\n", NULL);
//	ft_printf("%u, Hello %d, %c %s %%, hex %x %X", 123, -42, 'a', str, 9, 31);
//	int	j = ft_printf("\001\002\007\v\010\f\r\n");
//	printf("\nMy unsigned long ptr val: %lu\n", -1);
//   ft_printf(" %p ", NULL);
//	printf("%u\n", ft_printf(" %p %p ", NULL, NULL));
//	printf("%u\n", printf(" %p %p ", NULL, NULL));
	printf("%p ", (void *)7831446793853864325);
	printf("\n\n");
	ft_printf("%p ", (void *)7831446793853864325);
	return (0);
}*/
